...
public class Player : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Disabilita tutti i bordi se è abilitato l'avvolgimento dello schermo
        for (int i = 0; i < boundaries.Length; i++) {
            boundaries[i].SetActive(!screenWrapping);
        }

        // Converti i limiti dello spazio schermo in limiti dello spazio mondo
    ...
    {
        // Disattiva le collisioni per alcuni secondi dopo la generazione per garantire che il giocatore abbia abbastanza tempo per allontanarsi in sicurezza dagli asteroidi
        TurnOffCollisions();
    ...
    {
        // Spostati sul lato opposto dello schermo se il giocatore supera i limiti
